...
/**
 * @property array|null $content_type_weighting Content Type Weighting
 * @property bool|null $esLogDSL Log search DSL
 * @property bool|null $esLogDSLOnError On error, log search DSL
 * @property bool|null $searchImpov_simpleQuerySyntax Enhanced Search Syntax
 ...
 * @property bool|null $svOnlyShowPostsInRecentContent Only show posts in member's recent content
